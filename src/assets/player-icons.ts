...
const SVG_ATTRS = `width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="pointer-events: none;"`;
...
export const PLAYER_ICONS = {
  ...
  restart: `<svg ${SVG_ATTRS}>
    <polygon points="11 19 2 12 11 5 11 19" />
    <polygon points="22 19 13 12 22 5 22 19" />
  </svg>`,

  // Repeat: Cycle arrows
  repeat: `<svg ${SVG_ATTRS}>
  ...
  skip_forward: `<svg ${SVG_ATTRS}>
    <polygon points="5 4 15 12 5 20 5 4" />
    <line x1="19" y1="5" x2="19" y2="19" />
  </svg>`,

  skip_backward: `<svg ${SVG_ATTRS}>
    <polygon points="19 20 9 12 19 4 19 20" />
    <line x1="5" y1="19" x2="5" y2="5" />
  </svg>`,

  // Shuffle: Crossed arrows
  shuffle: `<svg ${SVG_ATTRS}>
  ...
  zoom_reset: `<svg ${SVG_ATTRS}>
    <circle cx="11" cy="11" r="8" />
    <line x1="21" y1="21" x2="16.65" y2="16.65" />
    <path d="M8 11h6" />
  </svg>`,

  settings: `<svg ${SVG_ATTRS}>
  ...
  eye_open: `<svg ${SVG_ATTRS}>
    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" />
    <circle cx="12" cy="12" r="3" />
  </svg>`,

  eye_closed: `<svg ${SVG_ATTRS}>
